...
function animate(time){
    ...
    carCanvas.height = window.innerHeight;  // for the full height of the windows//
    ...
    for (let i = 0; i < cars.length; i++){
    cars[i].draw(carCtx, "blue"); // takes value from car and uses context from ctx to draw it //
    }
